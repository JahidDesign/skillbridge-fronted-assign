...
const STYLES = `
  ...
  .ab-h1 em { font-style: italic; color: #fb923c; }
  ...
  .ab-btn, .ab-btn-ghost, .ab-btn-white, .ab-btn-outline-white {
    ...
    border-radius: var(--ab-r-md); padding: 13px 26px;
    font-family: var(--ab-body); font-size: 14.5px; font-weight: 700;
  ...
  .ab-hero-trust-item svg { flex-shrink: 0; color: var(--ab-brand); }
  .ab-hero-trust-sep { width: 1px; height: 12px; background: rgba(255,255,255,.2); }
  @media (max-width: 560px) { .ab-hero-trust-sep { display: none; } }
  ...
  .ab-cta-trust-item { display: flex; align-items: center; gap: 7px; font-size: 13px; font-weight: 500; color: rgba(255,255,255,.60); }
  ...
  /* ══════════════════════════════════════
     RESPONSIVE
  ══════════════════════════════════════ */
  @media (max-width: 500px) { .ab-cta-trust-sep { display: none; } .ab-cta-trust { gap: 10px 14px; } }
    ...
    <>
      ...
      <div className="ab-root">
        ...
        <section className="ab-hero">
          ...
          <div className="ab-hero-inner">
            ...
            <div className="ab-hero-text">
              ...
              <div className="ab-hero-btns">
                <Link href="/tutors"   className="ab-btn-white">Find a Tutor <ArrowRight size={14} /></Link>
                <Link href="/register" className="ab-btn-outline-white">Become a Tutor</Link>
              </div>
            </div>
          ...
          <div className="ab-hero-trust">
            <div className="ab-hero-trust-inner">
              ...
              <span className="ab-hero-trust-sep" />
              <span className="ab-hero-trust-item"><Star size={12} /> 4.8 average rating</span>
              <span className="ab-hero-trust-sep" />
              <span className="ab-hero-trust-item"><Zap size={12} /> Book in under 2 minutes</span>
              <span className="ab-hero-trust-sep" />
              <span className="ab-hero-trust-item"><Shield size={12} /> Money-back guarantee</span>
            </div>
          </div>
        </section>
        ...
        <section className="ab-mission-wrap ab-py">
          <div className="ab-inner">
            <div className="ab-mission-grid">
              <div>
                <div className="ab-pill-light"><BookOpen size={11} /> Why We Exist</div>
        ...
        <section className="ab-values-wrap ab-py">
          <div className="ab-inner">
            <div className="ab-sec-head">
              <div className="ab-pill-light"><Heart size={11} /> What We Stand For</div>
        ...
        <section className="ab-team-wrap ab-py">
          <div className="ab-inner">
            <div className="ab-sec-head">
              <div className="ab-pill-light"><Users size={11} /> The Educators</div>
        ...
        <section className="ab-testi-wrap ab-py">
          <div className="ab-inner">
            <div className="ab-sec-head">
              <div className="ab-pill-light"><Quote size={11} /> Student Stories</div>
        ...
        <section className="ab-cta-wrap">
          ...
          <div className="ab-cta-inner">
            ...
            <div className="ab-cta-trust">
              <span className="ab-cta-trust-item"><Star   size={13} color="#f59e0b" fill="#f59e0b" /> 4.8 average rating</span>
              <span className="ab-cta-trust-sep" />
              <span className="ab-cta-trust-item"><Users  size={13} color="#38bdf8" /> 50+ verified tutors</span>
              <span className="ab-cta-trust-sep" />
              <span className="ab-cta-trust-item"><Zap    size={13} color="#34d399" /> Book in under 2 min</span>
              <span className="ab-cta-trust-sep" />
              <span className="ab-cta-trust-item"><Shield size={13} color="#a78bfa" /> Money-back guarantee</span>
            </div>
          </div>
        </section>
